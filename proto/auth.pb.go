...
var file_proto_auth_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x11, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x52,
	...
	0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x42, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x2c, 0x0a, 0x04, 0x55, 0x73,
	0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02,
	0x69, 0x64, 0x12, 0x14, 0x0a, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x05, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x22, 0x43, 0x0a, 0x0f, 0x52, 0x65, 0x67, 0x69,
	...
	0x41, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x52, 0x6f, 0x6c, 0x65, 0x12, 0x17, 0x2e,
	...
	0x22, 0x00, 0x12, 0x3b, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x52, 0x6f, 0x6c, 0x65, 0x73, 0x12, 0x15,
...
var file_proto_auth_proto_goTypes = []interface{}{
	...
	(*CreateRoleRequest)(nil),  // 3: auth.CreateRoleRequest
	(*CreateRoleResponse)(nil), // 4: auth.CreateRoleResponse
...
var file_proto_auth_proto_depIdxs = []int32{
	2,  // 0: auth.GetRolesResponse.roles:type_name -> auth.Role
	5,  // 1: auth.LoginResponse.user:type_name -> auth.User
	5,  // 2: auth.ValidateResponse.user:type_name -> auth.User
	6,  // 3: auth.AuthService.Register:input_type -> auth.RegisterRequest
	8,  // 4: auth.AuthService.Login:input_type -> auth.LoginRequest
	10, // 5: auth.AuthService.Validate:input_type -> auth.ValidateRequest
	3,  // 6: auth.AuthService.CreateRole:input_type -> auth.CreateRoleRequest
	0,  // 7: auth.AuthService.GetRoles:input_type -> auth.GetRolesRequest
	7,  // 8: auth.AuthService.Register:output_type -> auth.RegisterResponse
	9,  // 9: auth.AuthService.Login:output_type -> auth.LoginResponse
	11, // 10: auth.AuthService.Validate:output_type -> auth.ValidateResponse
	4,  // 11: auth.AuthService.CreateRole:output_type -> auth.CreateRoleResponse
	1,  // 12: auth.AuthService.GetRoles:output_type -> auth.GetRolesResponse
