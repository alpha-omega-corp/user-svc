...
var file_proto_auth_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x04, 0x61, 0x75, 0x74, 0x68, 0x22, 0x11, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x55,
	...
	0x6f, 0x6c, 0x65, 0x52, 0x05, 0x72, 0x6f, 0x6c, 0x65, 0x73, 0x22, 0x2a, 0x0a, 0x04, 0x52, 0x6f,
	...
	0x72, 0x6f, 0x72, 0x22, 0x2c, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x60, 0x0a, 0x10, 0x56, 0x61, 0x6c, 0x69,
	...
	0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x12, 0x1e, 0x0a, 0x04, 0x75, 0x73,
	0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0a, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e,
	0x55, 0x73, 0x65, 0x72, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x32, 0xf8, 0x02, 0x0a, 0x0b, 0x41,
...
var file_proto_auth_proto_goTypes = []interface{}{
	...
	(*GetRolesRequest)(nil),    // 2: auth.GetRolesRequest
	(*GetRolesResponse)(nil),   // 3: auth.GetRolesResponse
	(*Role)(nil),               // 4: auth.Role
	(*CreateRoleRequest)(nil),  // 5: auth.CreateRoleRequest
	(*CreateRoleResponse)(nil), // 6: auth.CreateRoleResponse
...
var file_proto_auth_proto_depIdxs = []int32{
	7,  // 0: auth.GetUsersResponse.users:type_name -> auth.User
	4,  // 1: auth.GetRolesResponse.roles:type_name -> auth.Role
	7,  // 2: auth.LoginResponse.user:type_name -> auth.User
	7,  // 3: auth.ValidateResponse.user:type_name -> auth.User
	8,  // 4: auth.AuthService.Register:input_type -> auth.RegisterRequest
	10, // 5: auth.AuthService.Login:input_type -> auth.LoginRequest
	12, // 6: auth.AuthService.Validate:input_type -> auth.ValidateRequest
	5,  // 7: auth.AuthService.CreateRole:input_type -> auth.CreateRoleRequest
	2,  // 8: auth.AuthService.GetRoles:input_type -> auth.GetRolesRequest
	0,  // 9: auth.AuthService.GetUsers:input_type -> auth.GetUsersRequest
	9,  // 10: auth.AuthService.Register:output_type -> auth.RegisterResponse
	11, // 11: auth.AuthService.Login:output_type -> auth.LoginResponse
	13, // 12: auth.AuthService.Validate:output_type -> auth.ValidateResponse
	6,  // 13: auth.AuthService.CreateRole:output_type -> auth.CreateRoleResponse
	3,  // 14: auth.AuthService.GetRoles:output_type -> auth.GetRolesResponse
	1,  // 15: auth.AuthService.GetUsers:output_type -> auth.GetUsersResponse
